...
1. 対象に合った根拠を確認する。コードは動作と該当失敗経路、文章は意味・帰属・事実、設計は成立条件と矛盾を扱う。成果物にリンクや添付がある場合は、それらを通じて受け手に渡る情報も確認対象に含め、今回の目的・対象範囲・届け先に適しているかを照合する。執筆・制作時の確認記録は根拠として使い、その記録が今回必要な確認をカバーしているかも確かめる。
