...
理解を動かしたやり取りは、必要なものだけ短く紹介する。主要な根拠と、結論の意味を左右する条件や反証は本文へ置く。参照先や添付も、今回の読者に届ける内容として選ぶ。制作・照合に使った資料全体と、読者へ案内する資料は区別し、リンク先に含まれる内容の範囲と、案内する理由を確かめる。素材の一部を抽出する場合は、必要な引用や抜粋資料で、帰属と根拠を伝える方法も選べる。詳しい集計方法、編集履歴、引き継ぎは必要に応じて末尾や別資料へまとめる。
